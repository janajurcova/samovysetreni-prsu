      ...
      <body className="info__body">
        ...
        <section>
          ...
          <p className="info__paragraph">
            ...
            dávat pozor. Pokud něco nevypadá jak bys chtěla, máme tu rozcestník
            co dělat dál.{' '}
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p className="info__paragraph">
            ...
            Naše aplikace není dokonalá, proto mějte prosím pochopení. Více o
            nás a projektu si můžete přečíst zde (link).
          </p>
        </section>
      </body>
      ;
